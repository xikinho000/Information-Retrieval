...
public class DictionaryClass
{
    ...
    public DictionaryClass(String term, Integer docId, 
            Integer docLen, Integer maxTf, 
            Integer termFrequency, Integer docFrequency
    ){
        this.term = term;
        this.postingList = new TreeMap<Integer, DocDetails>();
        this.postingList.put(docId, 
                new DocDetails(docLen, maxTf, termFrequency));
    ...
    public int hashCode()
    {
        ...
        int result = 1;
        result = prime * result + (
                (docFrequency == null) ? 0 : docFrequency.hashCode());
        result = prime * result + (
                (postingList == null) ? 0 : postingList.hashCode());
        result = prime * result + (
